...
const QUESTIONS = [
  {
    text: "1. Cuando tenés tiempo libre, generalmente preferís...",
    options: [
  ...
  {
    text: "2. ¿Qué actividad te gustaría realizar más en un proyecto?",
    options: [
  ...
  {
    text: "3. En un trabajo en equipo, normalmente sos quien...",
    options: [
  ...
  {
    text: "4. ¿Qué tipo de desafío te resulta más interesante?",
    options: [
  ...
  {
    text: "5. ¿Qué materia o temática disfrutás más?",
    options: [
